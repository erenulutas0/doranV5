package com.microservices.shop.model;
...
public class Shop {
    ...
    /**
     * Çalışma Günleri (JSON formatında: ["MONDAY", "TUESDAY", ...])
     */
    @Column(columnDefinition = "TEXT")
    private String workingDays; // JSON array
    
    /**
     * Logo Media ID (Media Service'den)
     */
    @Column
    private UUID logoImageId;
    
    /**
     * Kapak Görseli Media ID (Media Service'den)
     */
    @Column
